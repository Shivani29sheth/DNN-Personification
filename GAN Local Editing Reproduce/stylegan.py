...
class MyLinear(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, gain=2**(0.5), use_wscale=False, lrmul=1, bias=True):
        super().__init__()
        he_std = gain * input_dim**(-0.5)
...
class G_synthesis(nn.Module):
    def __init__(self,
                 dlatent_size=512, num_channels=3, resolution=1024, fmap_base=8192, fmap_decay=1.0, fmap_max=512, use_styles=True, use_noise=True, nonlinearity='lrelu',use_wscale=True,use_instance_norm=True,blur_filter=[1, 2, 1],):
